        ...
        {data.map((item,i)=>(
            ...
            <div className="w-[25%]">
                <div className="flex items-center justify-around border-2 border-[#222] ml-4 w-[200px]">
                    ...
                    <span className='text-[20px] text-[#222] font-pops font-semibold' onClick={()=>handleIncrement(i)}>+</span>
                </div>
            </div>
            <div className="w-[25%]">
                <h6 className='pl-4 text-[20px] text-[#222] font-pops font-semibold'>${item.price * item.qun}</h6>
            </div>
           </div>
